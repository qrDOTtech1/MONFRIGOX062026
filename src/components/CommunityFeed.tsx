...
import { Heart, Clock, TrendingUp, ChefHat, Crown, Loader2, Plus } from 'lucide-react';
...
/**
 * Feed communautaire réutilisable.
 * Intégré comme onglet dans Explorer pour réduire le nombre de boutons de navigation.
 */
