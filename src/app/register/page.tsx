    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Rejoins Mon Frigo gratuitement</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <input type="text" placeholder="Prénom" value={name} onChange={e => setName(e.target.value)} className="input-field !pl-11" required />
          </div>
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          Déjà un compte?{' '}
          <Link href="/login" className="text-fresh-500 hover:underline">Se connecter</Link>
        </p>
      </div>
    </div>
  );
